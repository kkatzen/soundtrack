...
//print "<div class = 'info' style='background-image:url(\"http://i2.cdn.turner.com/cnn/dam/assets/111227022048-chocolate-candy-bar-story-top.jpg\");'>";
print "<div class = 'info' >";
print "<h3 class = 'author'>";
if($author)
	echo "Playlist generated for " . $author . "'s";
else
	echo "Playlist generated for ";
...
echo "<p class='dumbparagraph' style='margin:30px'>This <a href='https://developer.spotify.com/'>spotify playlist</a> was generated by comparing <a href='http://www.alchemyapi.com/'>keywords</a> from <a href='http://books.google.com/'>book descriptions</a> to <a href='https://developer.musixmatch.com/'>song lyrics</a>. " . "Learn more about <a href='http://books.google.com/books?id=" . $id . "'>" . "this book.</a></p>";
echo "</div>";
print "</div>";
